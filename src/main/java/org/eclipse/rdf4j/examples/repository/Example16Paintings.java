 ...
 */
public class Example16Paintings {
            ...
            throws IOException
    {
        ...
        try (RepositoryConnection conn = db.getConnection()) {
            ...
            Vector<String> Paintings = new Vector();
            Paintings.add("RodinaSlysit");
            Paintings.add("NaKuy");
            ...
            {
                conn.add(lozhkin, EX.CREATOR_OF, vf.createLiteral(Paintings.get(i)));

                IRI OnePainting = vf.createIRI(ex, Paintings.get(i));
                conn.add(OnePainting, RDF.TYPE, Painting);
                conn.add(OnePainting, RDFS.LABEL, vf.createLiteral(Paintings.get(i)));
            }
