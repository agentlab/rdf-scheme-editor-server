...
@Path("/rdf4j2-server")
@Component(service = StatementsComponent.class, property = { "osgi.jaxrs.resource=true" })
public class StatementsComponent {
	@Reference
	private RepositoryManager repositoryManager;

	@Reference
	RepositoryConfigController rcc;
	public StatementsComponent(){
	...
	public Object method(@Context UriInfo uriInfo,
		...
		try {
			...
			repositoryCon.add(in, baseURI.toString(), RDFFormat.RDFXML, contexts);
