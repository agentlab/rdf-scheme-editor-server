...
public class SampleTest extends KarafTestSupport {
    ...
    public void update() throws IOException {
        ...
        try {
            ...
            connectionUpdate.setRequestAction(actionUpdate);
            connectionUpdate.setRequestBody(bodyAfter);
            connectionUpdate.setRequestContext(context);
        ...
        try {
            ...
            if (connectionCheck.getResponseCode() != 200) {
                ...
                assertEquals(connectionCheck.getResponse().toString, bodyAfter);
            }
